                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Liste des interventions (design élégant et professionnel)
...
Color? _rowBgForStatut(String? raw) {
  ...
  final isNonAccomplies =
      n.contains('NON') &&
      (n.contains('ACCOMPL') || n.contains('EFFECTU') || n.contains('REALIS'));

  if (isRetard)
    return const Color.fromARGB(255, 255, 235, 238); // rouge très clair
  if (isNonAccomplies)
    return const Color.fromARGB(255, 255, 248, 225); // orange très clair
  if (isTraite)
    return const Color.fromARGB(255, 235, 255, 237); // vert très clair
...
Color _statusColor(String? status) {
  ...
  if (n.contains('RETARD')) return const Color(0xFFFFCDD2); // Light red
  if (n.startsWith('TRAIT')) return const Color(0xFFC8E6C9); // Light green
  if (n.contains('ANNUL')) return const Color(0xFFF5F5F5); // Light gray
...
Color _statusTextColor(String? status) {
  ...
  if (n.contains('RETARD')) return const Color(0xFFC62828); // Dark red
  if (n.startsWith('TRAIT')) return const Color(0xFF2E7D32); // Dark green
  if (n.contains('ANNUL')) return const Color(0xFF424242); // Dark gray
  if (n.contains('EN') && n.contains('COURS'))
